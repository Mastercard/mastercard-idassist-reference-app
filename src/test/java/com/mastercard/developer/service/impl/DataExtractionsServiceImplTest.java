...
class DataExtractionsServiceImplTest {
    ...
    void retrieveDataExtractionToken_accessTokenApiNoException_returningAccessToken() throws ApiException {
        ...
        when(idDocumentDataExtractionOcrApi.retrieveDataExtractionAccessToken(eq(DataExtractionsServiceExample.getAccessTokenExample()), eq(true))).thenReturn(accessTokenExample);
    ...
    @Test
    void retrieveDataExtractionTokenForWeb_returningAccessToken() throws ApiException {
        AccessToken accessTokenExample = AccessTokenExample.createAccessToken();
        when(idDocumentDataExtractionOcrApi.retrieveDataExtractionAccessToken(eq(DataExtractionsServiceExample.getAccessTokenExampleForWeb()), eq(true))).thenReturn(accessTokenExample);
    ...
    @Test
    void retrieveDataExtractionTokenForWeb_accessTokenApiException_logAndConvertToServiceException() throws ApiException {
        ApiException apiException = new ApiException();
        ServiceException serviceException = new ServiceException(apiException, new Error());
        doThrow(apiException).when(idDocumentDataExtractionOcrApi).retrieveDataExtractionAccessToken(eq(DataExtractionsServiceExample.getAccessTokenExampleForWeb()), eq(true));
    ...
    void retrieveDataExtractionToken_accessTokenApiException_logAndConvertToServiceException() throws ApiException {
        ApiException apiException = new ApiException();
        ServiceException serviceException = new ServiceException(apiException, new Error());
        doThrow(apiException).when(idDocumentDataExtractionOcrApi).retrieveDataExtractionAccessToken(eq(DataExtractionsServiceExample.getAccessTokenExample()), eq(true));
        when(exceptionUtil.logAndConvertToServiceException(eq(apiException))).thenReturn(serviceException);
    ...
    void extractScannedDocumentData_dataExtractionsApiNoException_returningAccessToken() throws ApiException {
        ...
        when(idDocumentDataExtractionOcrApi.extractScannedDocumentData(eq(SCAN_ID), eq(USER_CONSENT), eq(RETRIEVE_SELFIE), eq(RETRIEVE_DOCUMENT_IMAGES), eq(RETRIEVE_FACEMAP), eq(DOCUMENT_TYPE_DRIVING_LICENSE), eq(DOCUMENT_ISSUING_COUNTRY), eq(true))).thenReturn(documentVerificationExtractedDataExample);
    ...
    void extractScannedDocumentData_dataExtractionsApiException_logAndConvertToServiceException() throws ApiException {
        ApiException apiException = new ApiException();
        ServiceException serviceException = new ServiceException(apiException, new Error());
        doThrow(apiException).when(idDocumentDataExtractionOcrApi).extractScannedDocumentData(eq(SCAN_ID), eq(USER_CONSENT), eq(RETRIEVE_SELFIE), eq(RETRIEVE_DOCUMENT_IMAGES), eq(RETRIEVE_FACEMAP), eq(DOCUMENT_TYPE_DRIVING_LICENSE), eq(DOCUMENT_ISSUING_COUNTRY), eq(true));
        when(exceptionUtil.logAndConvertToServiceException(eq(apiException))).thenReturn(serviceException);
        try {
